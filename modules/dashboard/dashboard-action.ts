...
export async function getDashboardStats() {
  try {
    ...
    const totalRepos = 30; // TODO: FETCH TOTAL CONNECTED REPO FROM DB

    // Add try-catch for contribution fetching
    let totalCommits = 0;
    try {
    ...
    const totalReviews = 44; // TODO: COUNT AI REVIEWS FROM DATABASE
